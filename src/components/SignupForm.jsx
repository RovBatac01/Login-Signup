...
const SignupForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("https://login-signup-production-9bdf.up.railway.app/users", formData);
            setMessage("✅ " + response.data.message);
            setShowModal(true);

            await axios.post("https://login-signup-production-9bdf.up.railway.app/send-email", {
    ...
    const handleVerification = async () => {
        ...
        try {
            const response = await axios.post("https://login-signup-production-9bdf.up.railway.app/verify-code", {
                email: formData.email,
    ...
    const sendSuperAdminNotification = async (username, email, userId) => {
        try {
            await axios.post("https://login-signup-production-9bdf.up.railway.app/api/notifications/superadmin", {
                type: "new_user",
