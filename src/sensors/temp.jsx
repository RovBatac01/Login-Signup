...
const WaterTemperature = ({ theme, filter }) => { // Accept 'filter' prop
  ...
  const fetchData = useCallback(async (currentFilter) => {
    ...
    switch (currentFilter) {
      case "realtime":
        endpoint = "https://login-signup-production-e1ef.up.railway.app/data/temperature/realtime";
        isRealtime = true;
        break;
      case "24h":
        endpoint = "https://login-signup-production-e1ef.up.railway.app/data/temperature/24h";
        break;
      case "7d-avg": // Corresponds to '7d-avg' on backend
        endpoint = "https://login-signup-production-e1ef.up.railway.app/data/temperature/7d-avg";
        break;
      case "30d-avg": // Corresponds to '30d-avg' on backend
        endpoint = "https://login-signup-production-e1ef.up.railway.app/data/temperature/30d-avg";
        break;
      default:
        endpoint = "https://login-signup-production-e1ef.up.railway.app/data/temperature/24h"; // Fallback if filter is unexpected
        break;
    }
