...
const TurbidityMonitor = ({ theme, filter }) => {
  ...
  const fetchData = useCallback(async (currentFilter) => {
    ...
    switch (currentFilter) {
      case "realtime":
        endpoint = "https://login-signup-production-9bdf.up.railway.app/data/turbidity2/realtime";
        isRealtime = true;
        break;
      case "24h":
        endpoint = "https://login-signup-production-9bdf.up.railway.app/data/turbidity2/24h";
        break;
      case "7d-avg": // Frontend requests "7d", Backend expects "7d-avg" endpoint
        endpoint = "https://login-signup-production-9bdf.up.railway.app/data/turbidity2/7d-avg";
        break;
      case "30d": // Frontend requests "30d", Backend expects "30d-avg" endpoint
        endpoint = "https://login-signup-production-9bdf.up.railway.app/data/turbidity2/30d-avg";
        break;
      default:
        endpoint = "https://login-signup-production-9bdf.up.railway.app/data/turbidity2/24h"; // Fallback if filter is unexpected
        break;
    }
